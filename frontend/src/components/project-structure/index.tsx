...
export default function ProjectStructure(props: ProjectStructure) {
    ...
    return (
        <Stack gap="0" className={styles.project_structure}>
            <Link
            ...
            {props.childProjects?.map((project) => (
                <Stack key={project.id} className={styles.project__struct__sub}>
            ...
            <Stack
                gap="0"
                className={
                    !props.isChild ? styles.root__files : styles.child__files
                }
            >
